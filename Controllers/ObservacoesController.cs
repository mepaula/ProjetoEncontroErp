...
namespace ProjetoEncontro.Controllers
{
    public class ObservacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OnservacoesDescricao,ObservacoesLocal,ObservacoesData,UsuarioId,PessoaId")] Observacoes observacoes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OnservacoesDescricao,ObservacoesLocal,ObservacoesData,UsuarioId,PessoaId")] Observacoes observacoes)
        {
